...
echo "<h4>Enter The ID of Book: </h4>";
...
$SEARCH = $database->prepare("select * from book where id like :value");
...
foreach ($SEARCH as $row) {
    echo "<tr>";
       echo "<form method=post action='borrow_sh.php'>";
       echo "<td> $row[0]    </td>";    
       echo "<td> $row[1]    </td>";
       echo "<td> $row[2]    </td>";
       echo "<td> $row[3]    </td>";
       ...
       echo "<td> <input type='submit' value='Borrow The Book'> </td>";
