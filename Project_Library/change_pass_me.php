   ...
   !empty($_POST['new_con']))
{
    ...
    $check1= $db->query("select * from users where password='$current_md5' and id ='$id'");
    ...
    if(count($check1) > 0){
        ...
        $query = "update users set password='$new_md5' where id='$id' and password='$current_md5'";
...
?>
    <center>
        ...
        <form action="" method="POST">
            ...
            <button><a class="a" href="member/my_account_me.php">Back</a></button>
